...
class PessimisticGantt(tk.Frame):
    """!
    This class is used to display the pessimistic Gantt chart
    """
    ...
    def init_page(self):
        ...
        ax.barh(
            ...
            left=[task["max_start_date"] for task in self.tasks],
        ...
        plt.title("Pessimistic Gantt Diagram")
